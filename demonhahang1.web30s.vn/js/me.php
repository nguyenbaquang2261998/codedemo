...
$(function () {
    ...
    $("#" + name).html("<img src='http://demonhahang1.web30s.vn/images/loading/loading7.gif' alt='loading bang.vn'/>");
    $("#" + name).load(url);
